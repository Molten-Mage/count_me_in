...
const challengeCategories = [
  ChallengeCategory(
    ...
    objectives: [
      ...
      ObjectiveTemplate('Crunches', 50, 150),
      ObjectiveTemplate('Lunges', 50, 150),
      ObjectiveTemplate('Burpees', 20, 60),
      ObjectiveTemplate('Jumping jacks', 50, 150),
      ObjectiveTemplate('Minutes planking', 10, 40),
    ],
  ),
  ChallengeCategory(
    name: 'Health',
  ...
  ChallengeCategory(
    ...
    objectives: [
      ...
      ObjectiveTemplate('Articles finished', 2, 6),
    ],
  ),
  ChallengeCategory(
    name: 'Productivity',
    ...
    objectives: [
      ...
      ObjectiveTemplate('Emails cleared', 20, 100),
      ObjectiveTemplate('Errands completed', 5, 20),
    ],
  ),
  ChallengeCategory(
    name: 'Culture',
    ...
    objectives: [
      ...
      ObjectiveTemplate('Podcast episodes listened to', 10, 30),
      ObjectiveTemplate('New recipes tried', 2, 10),
    ],
  ),
  ChallengeCategory(
    name: 'Leisure',
    ...
    objectives: [
      ...
      ObjectiveTemplate('Hours learning a new language', 5, 10),
    ],
  ),
  ChallengeCategory(
    name: 'Outdoors',
    ...
    objectives: [
      ...
      ObjectiveTemplate('Hours bird watching', 3, 6),
    ],
  ),
  ChallengeCategory(
    name: 'Social',
